...
TEST(EncapsulationBankAccountTest, DepositTest) {
    EncapsulationBankAccount acc(1000);      // Create BankAccount object with 1000 balance

    acc.deposit(500);           // Deposit 500
    EXPECT_EQ(acc.getBalance(), 1500);  // Expect balance to be 1500
}

TEST(EncapsulationBankAccountTest, WithdrawTest) {
    EncapsulationBankAccount acc(1000);      // Create BankAccount object with 1000 balance
...
TEST(EncapsulationBankAccountTest, WithdrawOverBalanceTest) {
    EncapsulationBankAccount acc(500);       // Create BankAccount object with 500 balance

    acc.withdraw(1000);         // Try withdrawing more than balance
    EXPECT_EQ(acc.getBalance(), 500);   // Balance should remain 500 (no change)
}

TEST(EncapsulationBankAccountTest, MultipleOperationsTest) {
    EncapsulationBankAccount acc(1000);      // Create BankAccount object
